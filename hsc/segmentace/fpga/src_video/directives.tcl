...
go architect
ignore_memory_precedences -from /video_buf/core/core:rlp/main/read_mem(buffer:rsc.d) -to /video_buf/core/core:rlp/main/if#2:write_mem(buffer:rsc.d)
ignore_memory_precedences -from /video_buf/core/core:rlp/main/if#2:write_mem(buffer:rsc.d) -to /video_buf/core/core:rlp/main/read_mem(buffer:rsc.d)
go allocate
go extract
